...
const exercisesB = [
  { name: "Resistance Band Rows", instructions: "Anchor band low, pull handles, squeeze blades.", setsReps: "3 x 12" },
  { name: "Banded Chest Press", instructions: "Anchor band behind chest, press forward, return.", setsReps: "3 x 12" },
  { name: "Overhead Press", instructions: "Hold at shoulders, press overhead, lower.", setsReps: "3 x 10" },
  { name: "Bicep Curls", instructions: "Curl dumbbells/band to shoulders, lower.", setsReps: "3 x 12" },
  { name: "Tricep Extensions", instructions: "Anchor band overhead, extend arms up.", setsReps: "3 x 12" }
];
